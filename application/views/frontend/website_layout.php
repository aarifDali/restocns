...
<body class="<?php echo isset($language) && $language == "arabic" ? 'arabic-lang"' : '' ?>">
  ...
  <footer class="ct-footer footer-dark">
    ...
    <div class="footer-brand">
      ...
      <img src="<?php echo $system_logo; ?>" alt="logo" class="footer-logo-center">
      <span class="line"></span>
    </div>
    <?php
      $short_des = isset($banner_section->short_des) && $banner_section->short_des ? $banner_section->short_des : '';
      if ($short_des) {
        // Decode existing HTML entities to avoid double-encoding like &#039;
    ...
    ?>
      ...
      <ul class="d-flex social-links" style="justify-content:center; gap:14px; margin:-6px 0 24px;">
        <li>
          <!-- fb -->
          <a target="_blank" href="<?php echo isset($social_media->facebook_link) && $social_media->facebook_link ? $social_media->facebook_link : '' ?>"><svg width="11" height="21" viewBox="0 0 11 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
          <!-- insta -->
          <a target="_blank" href="<?php echo isset($social_media->twitter_link) && $social_media->twitter_link ? $social_media->twitter_link : '' ?>"><svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
          <!-- X -->
          <a target="_blank" href="<?php echo isset($social_media->google_link) && $social_media->google_link ? $social_media->google_link : '' ?>"><svg width="21" height="17" viewBox="0 0 21 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="footer-middle">
      <div class="container">
        <div class="footer-quick-links" style="display:flex;flex-wrap:wrap;gap:24px;align-items:center;justify-content:center;text-align:center;">
          <a href="<?php echo base_url().'online-order'; ?>" class="fq-link" style="color:#fff;text-decoration:none;">Menu</a>
          <a href="<?php echo base_url().'about-us'; ?>" class="fq-link" style="color:#fff;text-decoration:none;">About Us</a>
          <a href="<?php echo base_url().'contact-us'; ?>" class="fq-link" style="color:#fff;text-decoration:none;">Contact Us</a>
          <?php $footer_phone = isset($outlet_details->phone) && $outlet_details->phone ? $outlet_details->phone : ''; ?>
          <?php $footer_address = isset($outlet_details->address) && $outlet_details->address ? $outlet_details->address : ''; ?>
          <?php if($footer_phone): ?>
            <a href="tel:<?php echo $footer_phone; ?>" class="fq-link" style="color:#FFC107;font-weight:700;text-decoration:none;"><?php echo escape_output($footer_phone); ?></a>
          <?php endif; ?>
          <?php if($footer_address): ?>
            <a href="javascript:void(0)" class="fq-link" data-toggle="modal" data-target="#footerAddressModal" data-bs-toggle="modal" data-bs-target="#footerAddressModal" style="color:#fff;text-decoration:none;">Address</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
         ...
         <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content" style="background:#1f1f1f;color:#fff;border:0;padding-bottom:24px;">
            <div class="modal-header" style="border:0;">
              <h5 class="modal-title" id="footerAddressLabel">Address</h5>
            </div>
            <div class="modal-body" style="line-height:1.6;">
              <div style="display:flex;align-items:center;gap:24px;">
                <div style="flex:1;display:flex;justify-content:center;">
                  <div style="display:flex;flex-direction:column;align-items:center;gap:10px;">
                    <img src="<?php echo $system_logo; ?>" alt="logo" style="max-height:80px;object-fit:contain">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 2C8.686 2 6 4.686 6 8c0 5.25 6 12 6 12s6-6.75 6-12c0-3.314-2.686-6-6-6zm0 8.5A2.5 2.5 0 1 1 12 5.5a2.5 2.5 0 0 1 0 5z" fill="#ffffff"/>
                    </svg>
                  </div>
                </div>
                <div style="width:1px;background:rgba(255,255,255,0.2);height:100%;min-height:80px;"></div>
                <div style="flex:1;">
                  <p style="margin:0;">
                    <?php echo escape_output($footer_address); ?>
                  </p>
                </div>
              </div>
            </div>
